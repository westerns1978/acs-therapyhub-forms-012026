...
export const LATE_CANCELLATION_DEFINITION: FormDefinition<LateCancellationData> = {
  ...
  fieldDefinitions: [
    ...
    { id: 'acknowledgesPolicy', label: 'I have read and understand: a $40 late-cancellation fee is assessed for appointments cancelled less than 24 hours in advance of the appointment. Exceptions for emergencies are made at the discretion of ACS management.', type: 'boolean', required: true },
