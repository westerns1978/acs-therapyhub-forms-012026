...
const ReportSection: React.FC<FormSectionProps<MeetingReportData>> = ({ formData, setFormData, errors }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="pt-4">
        <label className="text-sm font-black uppercase tracking-widest text-slate-500 mb-4 block">Meeting type</label>
        <CheckboxGroup 
...
export const MEETING_REPORT_DEFINITION: FormDefinition<MeetingReportData> = {
  id: 'meeting-report',
  title: 'Support Group Meeting Report',
  description: 'Self-reported documentation of AA/NA or other 12-step meeting attendance.',
  category: 'Treatment',
  tags: ['SATOP'],
  difficulty: 'Simple',
  estimatedTime: '5 min',
