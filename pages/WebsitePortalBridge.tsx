...
import { ArrowRight, Phone, Shield, Clock, FileText, CreditCard, BarChart, MessageCircle, CheckCircle2 } from 'lucide-react';
...
const WebsitePortalBridge: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Website Header - matches stlacs.com style */}
                ...
                <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        ...
                        <h1 className="text-5xl md:text-6xl font-black text-gray-900 leading-[1.1] tracking-tight">
                            ...
                            <span className="text-red-700">Now in Your Hands.</span>
                        </h1>
                        <p className="text-lg text-gray-600 leading-relaxed max-w-lg">
                            Access your SATOP program forms, track compliance progress, manage payments, 
                            and communicate with your counselor — all from one secure portal.
                        </p>
                        ...
                        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 transform rotate-1 hover:rotate-0 transition-all duration-500">
                            ...
                            <div className="space-y-4">
                                <div className="bg-gradient-to-r from-red-700 to-red-800 rounded-2xl p-5 text-white">
                                    <p className="text-[10px] font-bold uppercase tracking-widest opacity-80">Hello, Alice!</p>
                                    <p className="text-2xl font-black mt-1">SATOP Level IV</p>
                                    <p className="text-sm opacity-80 mt-1">Compliance: 85%</p>
                                </div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div className="flex-1 bg-amber-50 border border-amber-100 rounded-xl p-2 text-center">
                                        <p className="text-[9px] font-bold text-amber-600">⏳ Recovery</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="bg-gray-50 py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500 mt-3 max-w-xl mx-auto">Your secure client portal puts your entire program at your fingertips.</p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: FileText, title: 'Complete Forms Online', desc: 'Fill out intake paperwork, consent forms, and recovery plans from any device.', color: 'bg-red-50 text-red-700' },
                            { icon: BarChart, title: 'Track Your Progress', desc: 'See your SROP hours, compliance score, and program milestones in real-time.', color: 'bg-blue-50 text-blue-700' },
                            { icon: Clock, title: 'Manage Appointments', desc: 'View upcoming sessions, join virtual rooms, and request schedule changes.', color: 'bg-green-50 text-green-700' },
                            { icon: CreditCard, title: 'Pay Online', desc: 'View your balance, make payments, and download tax statements securely.', color: 'bg-purple-50 text-purple-700' },
                            { icon: MessageCircle, title: 'AI-Powered Support', desc: 'Clara, your recovery assistant, is available 24/7 to answer questions.', color: 'bg-indigo-50 text-indigo-700' },
                            { icon: Shield, title: 'HIPAA Secure', desc: 'All data is encrypted and compliant with healthcare privacy standards.', color: 'bg-amber-50 text-amber-700' },
                        ].map((feature, i) => (
            ...
            <section className="py-20">
                <div className="max-w-5xl mx-auto px-6">
                    <h2 className="text-3xl font-black text-gray-900 text-center tracking-tight mb-16">Getting Started is Simple</h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { step: '1', title: 'Receive Your Login', desc: 'After your initial assessment, your counselor provides secure portal access.' },
                            { step: '2', title: 'Complete Your Forms', desc: 'Fill out required paperwork online before your first session — no paper needed.' },
                            { step: '3', title: 'Track & Succeed', desc: 'Monitor your progress, attend sessions, and stay compliant through your entire program.' },
                        ].map((item, i) => (
            ...
            <section className="bg-red-700 py-16">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl font-black text-white tracking-tight">Ready to Access Your Portal?</h2>
                    <p className="text-red-100 mt-3 max-w-lg mx-auto">If you've been enrolled in a program with ACS, click below to sign in. New clients should call our office first.</p>
            ...
            <footer className="bg-gray-900 text-gray-400 py-12">
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p className="text-sm leading-relaxed">Assessment & Counseling Solutions provides court-mandated substance abuse treatment, DWI education, and individual counseling services.</p>
                    </div>
                    <div>
                ...
                <div className="max-w-7xl mx-auto px-6 mt-8 pt-8 border-t border-gray-800 text-center text-xs">
                    <p>&copy; {new Date().getFullYear()} Assessment & Counseling Solutions. All rights reserved. Powered by GeMyndFlow™</p>
                </div>
            </footer>
        </div>
    );
