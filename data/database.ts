...
const initialDbClients: Omit<Client, 'initials'>[] = [
    {
        id: '1', name: 'Alice Johnson', phone: '314-555-1234', avatarUrl: 'https://i.pravatar.cc/150?img=1', lastSession: getRelativeDateStr(-2), program: 'SROP', programType: 'SATOP_Level_IV', status: 'active', enrollmentDate: getRelativeDateStr(-45), completionPercentage: 75, nextDeadline: getRelativeDateStr(12), missingDocuments: ['DMV Notification'], caseNumber: 'STL-2024-001', probationOfficer: 'Jane Doe', licenseStatus: 'Reinstated', dwiConvictions: 1, billingType: 'Court Mandate', county: 'St. Louis', referralSource: 'St. Louis County Court', interlockStatus: 'Compliant', gamification: { points: 1250, badges: ['Phase 1 Complete', 'Consistent Attendance', '50% Done'] }, attendanceHistory: ['present', 'present', 'late', 'present'], folder_link: 'https://console.cloud.google.com/storage/browser/acs-therapy-hub-sample-docs',
    },
    {
        id: '2', name: 'Bob Williams', phone: '636-555-5678', avatarUrl: 'https://i.pravatar.cc/150?img=2', lastSession: getRelativeDateStr(-5), program: 'REACT', programType: 'Individual_Counseling', status: 'active', enrollmentDate: getRelativeDateStr(-20), completionPercentage: 30, nextDeadline: getRelativeDateStr(-3), missingDocuments: ['Treatment Plan', 'Insurance Documentation'], caseNumber: 'JEF-2024-005', probationOfficer: 'John Smith', licenseStatus: 'Suspended', dwiConvictions: 2, billingType: 'State Funded', county: 'Jefferson', referralSource: 'Jefferson County Court', interlockStatus: 'Violation', gamification: { points: 450, badges: [] }, attendanceHistory: ['present', 'absent', 'present', 'absent'], folder_link: 'https://console.cloud.google.com/storage/browser/acs-therapy-hub-sample-docs',
    },
    {
        id: '3', name: 'Charlie Brown', phone: '314-555-9876', avatarUrl: 'https://i.pravatar.cc/150?img=3', lastSession: getRelativeDateStr(-60), program: 'Anger Management', programType: 'Individual_Counseling', status: 'completed', enrollmentDate: getRelativeDateStr(-120), completionPercentage: 100, missingDocuments: [], caseNumber: 'STL-2023-101', probationOfficer: 'Jane Doe', licenseStatus: 'Valid', dwiConvictions: 1, billingType: 'Sliding Scale', county: 'St. Louis', referralSource: 'Self-referred', interlockStatus: 'Not Required', gamification: { points: 2000, badges: ['Program Graduate', 'Perfect Attendance', 'Compliance Champion'] }, attendanceHistory: ['present', 'present', 'present', 'present'], folder_link: 'https://console.cloud.google.com/storage/browser/acs-therapy-hub-sample-docs',
    },
    {
        id: '4', name: 'Diana Prince', phone: '314-555-4444', avatarUrl: 'https://i.pravatar.cc/150?img=5', lastSession: getRelativeDateStr(-1), program: 'SROP', programType: 'SATOP_Level_IV', status: 'active', enrollmentDate: getRelativeDateStr(-10), completionPercentage: 15, nextDeadline: getRelativeDateStr(20), missingDocuments: [], caseNumber: 'STL-2024-045', probationOfficer: 'Steve Trevor', licenseStatus: 'Suspended', dwiConvictions: 1, billingType: 'Insurance', county: 'St. Louis', referralSource: 'Attorney', interlockStatus: 'Awaiting Installation', gamification: { points: 150, badges: ['First Steps'] }, attendanceHistory: ['present', 'present'], folder_link: '',
    },
    {
        id: '5', name: 'Evan Wright', phone: '636-555-2222', avatarUrl: 'https://i.pravatar.cc/150?img=8', lastSession: getRelativeDateStr(-14), program: 'DOT', programType: 'Substance_Use_Assessment', status: 'active', enrollmentDate: getRelativeDateStr(-90), completionPercentage: 40, nextDeadline: getRelativeDateStr(-10), missingDocuments: ['Court Order', 'Payment Records'], caseNumber: 'JEF-2023-888', probationOfficer: 'Unknown', licenseStatus: 'Revoked', dwiConvictions: 3, billingType: 'Court Mandate', county: 'Jefferson', referralSource: 'Probation', interlockStatus: 'Violation', gamification: { points: 0, badges: [] }, attendanceHistory: ['absent', 'absent', 'late'], folder_link: '',
    },
    {
        id: '6', name: 'Fiona Gallagher', phone: '314-555-7777', avatarUrl: 'https://i.pravatar.cc/150?img=9', lastSession: getRelativeDateStr(-3), program: 'Compulsive Gambling', programType: 'Individual_Counseling', status: 'active', enrollmentDate: getRelativeDateStr(-60), completionPercentage: 60, nextDeadline: getRelativeDateStr(5), missingDocuments: [], caseNumber: 'STL-2024-112', probationOfficer: 'Jimmy Steve', licenseStatus: 'Valid', dwiConvictions: 0, billingType: 'Sliding Scale', county: 'St. Louis', referralSource: 'Self-referred', interlockStatus: 'Not Required', gamification: { points: 800, badges: ['Consistent Attendance'] }, attendanceHistory: ['present', 'present', 'present', 'present'], folder_link: '',
    },
    {
        id: '7', name: 'George Miller', phone: '314-555-3333', avatarUrl: 'https://i.pravatar.cc/150?img=11', lastSession: getRelativeDateStr(0), program: 'SROP', programType: 'SATOP_Level_IV', status: 'active', enrollmentDate: getRelativeDateStr(-5), completionPercentage: 5, nextDeadline: getRelativeDateStr(25), missingDocuments: ['Intake Assessment'], caseNumber: 'STL-2024-200', probationOfficer: 'Max Rockatansky', licenseStatus: 'Suspended', dwiConvictions: 1, billingType: 'Court Mandate', county: 'St. Louis', referralSource: 'Court', interlockStatus: 'Compliant', gamification: { points: 50, badges: [] }, attendanceHistory: ['present'], folder_link: '',
    },
    {
        id: '8', name: 'Hannah Abbott', phone: '636-555-9999', avatarUrl: 'https://i.pravatar.cc/150?img=12', lastSession: getRelativeDateStr(-4), program: 'REACT', programType: 'Individual_Counseling', status: 'active', enrollmentDate: getRelativeDateStr(-30), completionPercentage: 20, nextDeadline: getRelativeDateStr(-1), missingDocuments: ['Payment Records'], caseNumber: 'JEF-2024-123', probationOfficer: 'Neville L.', licenseStatus: 'Suspended', dwiConvictions: 1, billingType: 'State Funded', county: 'Jefferson', referralSource: 'Court', interlockStatus: 'Compliant', gamification: { points: 300, badges: [] }, attendanceHistory: ['late', 'present', 'absent'], folder_link: '',
    }
];
